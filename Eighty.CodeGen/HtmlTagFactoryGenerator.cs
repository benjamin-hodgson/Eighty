...
";
        ...
        {{
            return new TagBuilder(name, ImmutableArrayFactory.Create({AttrArgs(number)}));
        }}
";
        ...
        {{{CheckChildNulls(number)}
            return new Tag(name, ImmutableArray.Create<Attr>(), ImmutableArrayFactory.Create({ChildArgs(number)}));
        }}
";
        ...
        {{
            return new SelfClosingTag(name, ImmutableArrayFactory.Create({AttrArgs(number)}));
        }}
";
    }
}
